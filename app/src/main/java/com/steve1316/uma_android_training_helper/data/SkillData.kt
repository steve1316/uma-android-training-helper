	...
	companion object {
		val skills = mapOf(
			...
			"アクセルX" to mapOf(
				...
				"englishDescription" to "Increase speed and power slightly when close to the lead in last 200m"),
			"レッドエース" to mapOf(
				"id" to 10091,
			...
			"全力Vサインッ！" to mapOf(
				...
				"englishDescription" to "On the final straight your desire not to lose, increases your speed slightly"),
			"学級委員長+速さ＝バクシン" to mapOf(
				"id" to 10411,
				"englishName" to "Class President + Speed = Bakushin",
				"englishDescription" to "While fighting for the lead during the second part of the race, slightly increase your speed through displaying your Bakushin power"),
			"クリアハート" to mapOf(
				"id" to 10451,
				"englishName" to "Clear Heart",
				"englishDescription" to "Be in a good position during the middle stage of the race to slightly recover your endurance"),
			"ワクワクよーいドン" to mapOf(
				"id" to 10521,
				"englishName" to "Ready, Steady, Go!",
				"englishDescription" to "Being at the back during the last corner, slightly restores your endurance when you see another horse girl"),
			"来てください来てください！" to mapOf(
				"id" to 10561,
				"englishName" to "Come, Come!",
				"englishDescription" to "If during the last leg of the race your way to the front of the field is blocked, your power of divination will make it slightly easier to spot an opening"),
			"アタシもたまには、ね？" to mapOf(
				"id" to 10601,
				"englishName" to "You know, sometimes even I can…",
				"englishDescription" to "When you're in 3rd place at the end of the race and about to lose, you gain a little bit more fighting spirit and slightly increase your speed"),
			...
			"引っ込み思案" to mapOf(
				...
				"englishDescription" to "Harder at showing off your ability when at least 6 other girls share your strategy"),
			"徹底マーク◎" to mapOf(
				"id" to 200291,
			...
			"坂苦手" to mapOf(
				...
				"englishDescription" to "Become slightly more tired during uphills"),
			"バ群嫌い" to mapOf(
				"id" to 200401,
				"englishName" to "Crowd Hater",
				"englishDescription" to "Endurance decreases slightly when surrounded"),
			"あきらめ癖" to mapOf(
				"id" to 200411,
			...
			"ゲート難" to mapOf(
				...
				"englishDescription" to "Worse at starts, slightly increases delay of Late Starts"),
			"鋼の意志" to mapOf(
				"id" to 200441,
			...
			"逃げためらい" to mapOf(
				...
				"englishDescription" to "Instill hesitation and slows down girls with <Strategy・Runner> in the Final Leg"),
			"先行けん制" to mapOf(
				"id" to 200861,
			...
			"先行ためらい" to mapOf(
				...
				"englishDescription" to "Instill hesitation and slows down girls with <Strategy・Leader> in the Final Leg"),
			"差しけん制" to mapOf(
				"id" to 200891,
			...
			"差しためらい" to mapOf(
				...
				"englishDescription" to "Instill hesitation and slows down girls with <Strategy・Betweener> in the Final Leg"),
			"追込けん制" to mapOf(
				"id" to 200921,
			...
			"追込ためらい" to mapOf(
				...
				"englishDescription" to "Instill hesitation and slows down girls with <Strategy・Chaser> in the Final Leg"),
			"大井レース場◎" to mapOf(
				"id" to 200951,
			...
			"後方釘付" to mapOf(
				...
				"englishDescription" to "Short・When in the front in Opening Leg, girls in the back become slightly weakened"),
			"逃亡禁止令" to mapOf(
				"id" to 201021,
			...
			"イナズマステップ" to mapOf(
				...
				"englishDescription" to "Medium・Become slightly harder to box in if behind in Middle Leg"),
			"神業ステップ" to mapOf(
				"id" to 201141,
